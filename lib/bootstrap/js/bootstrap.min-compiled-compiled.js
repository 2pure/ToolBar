...
/*!
 * Generated using the Bootstrap Customizer (http://bootstrap-3.ru/customize.php?id=90b5d774d99af29f84b2)
 * Config saved to config.json and https://gist.github.com/90b5d774d99af29f84b2
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+function (t) {
  ...
  function e(e) {
    ...
    var e = t.Event("show.bs." + this.type);if (this.hasContent() && this.enabled) {
      ...
      }var g = this.getCalculatedOffset(r, d, p, c);this.applyPlacement(g, r);var v = function () {
    ...
    var o = this.tip(),
        ...
        r = parseInt(o.css("margin-left"), 10);isNaN(a) && (a = 0), isNaN(r) && (r = 0), e.top += a, e.left += r, t.offset.setOffset(o[0], t.extend({ using: function (t) {
  ...
  function e(e) {
    ...
    if (!this.transitioning && this.$element.hasClass("in")) {
      var e = t.Event("hide.bs.collapse");if (this.$element.trigger(e), !e.isDefaultPrevented()) {
        var i = this.dimension();this.$element[i](this.$element[i]())[0].offsetHeight, this.$element.addClass("collapsing").removeClass("collapse in").attr("aria-expanded", !1), this.$trigger.addClass("collapsed").attr("aria-expanded", !1), this.transitioning = 1;var n = function () {
